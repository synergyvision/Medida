...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-24"><strong>(\#prp:unnamed-chunk-24) </strong></span>Sean $A, B\subseteq \Omega$, entonces:
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-42"><strong>(\#prp:unnamed-chunk-42) </strong></span>La intersección arbitraria de anillos, es un anillo.
</div>\EndKnitrBlock{proposition}
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-50"><strong>(\#prp:unnamed-chunk-50) </strong></span>Sea $(\Omega, \tau)$ un espacio toplológico segundo numerable. Sea $\mathcal{G}$ una base numerable de $\tau$. Entonces $\sigma(\mathcal{G})=\mathcal{B}(\Omega)$.
</div>\EndKnitrBlock{proposition}
...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-64"><strong>(\#exm:unnamed-chunk-64) </strong></span>*La medida de contar*. La función $\mu:\wp(\Omega)\longrightarrow \overline{\mathbb{R}^{+}}$, definida por $$\mu(A)=\left\lbrace \begin{array}{cc}
...
\BeginKnitrBlock{theorem}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-75"><strong>(\#thm:unnamed-chunk-75) </strong></span>	Sea $\mathcal{A}$ un álgebra y $\mathcal{M}$ una clase monótona tal que $\mathcal{A}\subseteq\mathcal{M}$, entonces $\sigma(\mathcal{A})\subseteq\mathcal{M}$.
</div>\EndKnitrBlock{theorem}
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-80"><strong>(\#prp:unnamed-chunk-80) </strong></span>La función $l$ es finitamente aditiva en $\mathcal{I}$. Es decir, para $I\in\mathcal{I}$, si $I=\bigcup_{k=1}^{n} I_{k}$ con cada $I_{k}\in\mathcal{I}$ y $I_{k}\cap I_{m}=\emptyset$ si $k\neq m$, entonces $l(I)=\sum_{k=1}^{n} l(I_{k})$.
</div>\EndKnitrBlock{proposition}
...
\BeginKnitrBlock{theorem}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-105"><strong>(\#thm:unnamed-chunk-105) </strong></span>La $\sigma$-álgebra de Borel, está contenida en $\mathcal{M}$, esto es $\mathcal{B}(\mathbb{R})\subseteq\mathcal{M}$.
</div>\EndKnitrBlock{theorem}
...
\BeginKnitrBlock{theorem}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-107"><strong>(\#thm:unnamed-chunk-107) </strong></span>$m$ es la única medida en $\mathcal{B}(\mathbb{R})$ que coincide con la función $l$ en el anillo de los intervalos.
</div>\EndKnitrBlock{theorem}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Sea $\mu$ una medida que coincide con la función $l$ en $\mathcal{I}$. Del teorema \@ref(thm:teorema158)  se sigue el resultado.
</div>\EndKnitrBlock{proof}

\BeginKnitrBlock{theorem}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-109"><strong>(\#thm:unnamed-chunk-109) </strong></span>Sea $E\subseteq\mathbb{R}$. Las siguientes son equivalentes:
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-110"><strong>(\#prp:unnamed-chunk-110) </strong></span>Sea $A\subseteq\mathbb{R}$. $A\in\mathcal{B}(\mathbb{R})^{m}$ si y solo si existen $B_{1}, B_{2}\in\mathcal{B}(\mathbb{R})$ tal que $B_{1}\subseteq A\subseteq B_{2}$ y $m(B_{2}-B_{1})=0$.
</div>\EndKnitrBlock{proposition}

\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-111"><strong>(\#prp:unnamed-chunk-111) </strong></span>$\mathcal{M}=\mathcal{B}(\mathbb{R})$.
</div>\EndKnitrBlock{proposition}
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-112"><strong>(\#def:unnamed-chunk-112) </strong></span>Una función $F:\mathbb{R}\longrightarrow\mathbb{R}$ es una *función de Stieltjes* si satisface:

(i.) $F$ es monótona creciente, es decir, si $x\leq Y$, entonces $F(x)\leq F(y)$.
(ii.) $F$ es continua a la derecha.
</div>\EndKnitrBlock{definition}

\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-113"><strong>(\#exm:unnamed-chunk-113) </strong></span>La función *parte entera* es una función de Stieltjes.
</div>\EndKnitrBlock{example}
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-114"><strong>(\#prp:unnamed-chunk-114) </strong></span>Sea $\mu: \mathcal{B}(\mathbb{R})\longrightarrow \overline{\mathbb{R}^{+}}$ una medida con la propiedad $\mu(A)\infty$ siempre que $A$ sea un conjunto acotado. Sea $F:\mathbb{R}\rightarrow \mathbb{R}$ definida por 
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-115"><strong>(\#def:unnamed-chunk-115) </strong></span>Sea $f:\mathbb{R}\longrightarrow\mathbb{R}$. Se dice que $f$ es *medible Borel* cuando para todo conjunto boreliano $B$, se tiene que $f^{-1}(B)$ es un conjunto boreliano. Es decir, $f^{-1}(\mathcal{B}(\mathbb{R}))\subseteq\mathcal{B}(\mathbb{R})$.
...
\BeginKnitrBlock{lemma}<div class="lemma"><span class="lemma" id="lem:unnamed-chunk-116"><strong>(\#lem:unnamed-chunk-116) </strong></span>Sea $\mathcal{C}$ una clase de subconjuntos que genera a $\mathcal{B}(\mathbb{R})$ y $f:(X,\mathcal{A})\longrightarrow\mathbb{R}$. Entonces, $f^{-1}(\mathcal{B}(\mathbb{R}))\subseteq\mathcal{A}$ si y solo si $f^{-1}(\mathcal{C})\subseteq\mathcal{F}$.
</div>\EndKnitrBlock{lemma}

\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-117"><strong>(\#prp:unnamed-chunk-117) </strong></span>Sea $f: X\longrightarrow \mathbb{R}$. Las siguientes afirmaciones son equivalentes.
...
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Basta notar que las familias de conjuntos abiertos, de conjuntos cerrados, de intervalos de la forma $(a,b)$, con $a,b\in\mathbb{R}$, de intervalos de la forma $(p,q)$, con $p,q\in\mathbb{Q}$ y de los intervalos de la forma $<a,\infty)$, con $a\in\mathbb{R}$, generan la $\sigma$-álgebra de Borel.
</div>\EndKnitrBlock{proof}

\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-119"><strong>(\#exm:unnamed-chunk-119) </strong></span>Si $(X,\mathcal{A})$ es un espacio medible y $A\in\mathcal{A}$ entonces la función indicatriz $\chi_{A}$, es una función $\mathcal{A}$-medible.
</div>\EndKnitrBlock{example}

\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-120"><strong>(\#exm:unnamed-chunk-120) </strong></span>Las funciones continuas son medibles Borel:
Sea $X$ un espacio topológico y $f:X\longrightarrow \mathbb{R}$ una función continua. Entonces $f$ es medible Borel.
</div>\EndKnitrBlock{example}

\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-121"><strong>(\#exm:unnamed-chunk-121) </strong></span>Las funciones constantes son medibles: Si $(X,\mathcal{A})$ es un espacio medible y $\lambda\in\mathbb{R}$. La función $f:X\longrightarrow \mathbb{R}:x\mapsto \lambda$ es una función $\mathcal{A}$-medible.
</div>\EndKnitrBlock{example}

\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-122"><strong>(\#exm:unnamed-chunk-122) </strong></span>Las variables aleatorias son funciones medibles:
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-123"><strong>(\#prp:unnamed-chunk-123) </strong></span>Sean $f,g: X\longrightarrow \mathbb{R}$ funciones $\mathcal{A}$-medibles. Entonces:
...
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Sean $f,g: X\longrightarrow \mathbb{R}$ funciones $\mathcal{A}$-medibles.
...
\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}Note que las funciones $f^{+}$ y $f^{-}$ son funciones no negativas. También se tiene que $f^{-}=-f\vee 0$.
</div>\EndKnitrBlock{remark}

\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-126"><strong>(\#prp:unnamed-chunk-126) </strong></span>Sean $f,g:X\longrightarrow\overline{\mathbb{R}}$ funciones $\mathcal{A}$-medibles, entonces $f\vee g$ y $f\wedge g$ son funciones $\mathcal{A}$-medibles.
</div>\EndKnitrBlock{proposition}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Como $\{x\in X:(f\vee g)(x)< r \}=\{x\in X:f(x)< r \}\cap\{x\in X:g(x)< r \}$ y $\{x\in X:(f\wedge g)(x)> r \}=\{x\in X:f(x)> r \}\cup\{x\in X:g(x)> r \}$, para cualquier $r\in\mathbb{R}$, de las hipótesis se sigue el resultado.
</div>\EndKnitrBlock{proof}

\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}Por la proposión anterior, se sigue que:
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-129"><strong>(\#prp:unnamed-chunk-129) </strong></span>Sean $f,g:X\longrightarrow\overline{\mathbb{R}}$ funciones $\mathcal{A}$-medibles. Entonces $\forall\epsilon>0$ se tiene que $\{x\in X: |f(x)-g(x)|>\epsilon \}\in\mathcal{A}$.
</div>\EndKnitrBlock{proposition}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Como $|f-g|$ es una función $\mathcal{A}$-medible y el intervalo $(\epsilon,\infty)$ es un conjunto Boreliano, se tiene el resultado.
</div>\EndKnitrBlock{proof}
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-131"><strong>(\#def:unnamed-chunk-131) </strong></span>Sea $(X,\mathcal{A})$ un espacio medible. Una función $f:X\longrightarrow\mathbb{R}$ de la forma  $$f(x)=\sum_{k=1}^{n} C_{k}\chi_{A_{k}}(x) \mbox{ donde } x_{k}\in\mathbb{R} \mbox{ y }A_{k}\in\mathcal{A}$$
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-132"><strong>(\#def:unnamed-chunk-132) </strong></span>Sea $(X,\mathcal{A},\mu)$ un espacio de medida y $f:X\longrightarrow \overline{R}$ diremos que $f$ cumple cierta propiedad $P$ *$\mu$-casi siempre* (abreviado $\mu$-c.s.) si y solo si $\{x\in X: f(x) \mbox{ no cumple } P \}\in\mathcal{A}$ y $\mu(\{x\in X: f(x) \mbox{ no cumple } P \})=0$. 
</div>\EndKnitrBlock{definition}
...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-133"><strong>(\#exm:unnamed-chunk-133) </strong></span>Sea $f=\chi_{\mathbb{R}-\mathbb{Q}}$. La propiedad *$f$ es constantemente igual a $1$* no es cierta. Pero si se cumple en casi todo punto, ya que $\{x\in \mathbb{R}: f(x)\neq 1 \}=\mathbb{Q}$.
</div>\EndKnitrBlock{example}

\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-134"><strong>(\#prp:unnamed-chunk-134) </strong></span>Sean $f,g:\mathbb{R}\longrightarrow\mathbb{R}$ funciones. Si $f$ es medible lebesgue y $g=f$ casi siempre, entonces $g$ es medible lebesgue.
</div>\EndKnitrBlock{proposition}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Sea $E=\{x\in X: f(x)=g(x)\}$. Sea $k\in\mathbb{R}$, 
	$$\begin{array}{rl}
...
\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}En la proposición anterior, la hipótesis *$f$ es medible Lebesgue* es esencial. Si esta se cambia por *$f$ es medible Borel* no es cierta la proposición.
</div>\EndKnitrBlock{remark}
...
\BeginKnitrBlock{theorem}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-137"><strong>(\#thm:unnamed-chunk-137) </strong></span>Sea $(X,\mathcal{A})$ un espacio medible y $f:X\longrightarrow\overline{\mathbb{R}}$ una función $\mathcal{A}$-medible no negativa ($f\geq 0$). Entonces, existe una sicesión creciente de funciones $\mathcal{F}$-simples, $\{f_{n} \}_{n\in\mathbb{N}}$ que converge puntualmente a $f$. Además, si $f$ es acotada, entonces $\{f_{n} \}_{n\in\mathbb{N}}$ converge uniformemente a $f$.
</div>\EndKnitrBlock{theorem}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Construiremos una sucesión creciente de funciones simples a partir de una función medible no negativa. Para cada $n\in\mathbb{N}$, consideraremos una partición del intervalo $[0,\infty)$ en el intervalo $[2^{n},\infty)$ y $2^{2n}$ intervalos que resultan de dividir el intervalo $[0,2^{n}]$ en  subintervalos de longitud $\frac{1}{2^{n}}$. A partir de estos intervalos definimos los conjuntos medibles siguientes
	$$\begin{array}{rl}
...
\BeginKnitrBlock{corollary}<div class="corollary"><span class="corollary" id="cor:unnamed-chunk-139"><strong>(\#cor:unnamed-chunk-139) </strong></span>Sea $f:(X,\mathcal{A})\longrightarrow (\mathbb{R},\mathcal{B}(\mathbb{R}))$ $\mathcal{A}$-medible. Entonces existe una sucesión de funciones simples $\{f_{n}\}_{n}$ tal que $f_{n}(x)\rightarrow f(x)$ para cada $x\in X$. Además, si $f$ es una función acotada, la convergencia es uniforme.
</div>\EndKnitrBlock{corollary}

Otro corolario del teorema es

\BeginKnitrBlock{corollary}<div class="corollary"><span class="corollary" id="cor:unnamed-chunk-140"><strong>(\#cor:unnamed-chunk-140) </strong></span>Sea $f:(X,\mathcal{A})\longrightarrow (\mathbb{R},\mathcal{B}(\mathbb{R}))$ $\mathcal{A}$-medible y acotada. Entonces $\forall\epsilon>0$ existe una sucesión de funciones simples $\{f_{n}\}_{n}$ tal que $|f_{n}(x)-f(x)|$ para todo $x\in X$.
</div>\EndKnitrBlock{corollary}
...
\BeginKnitrBlock{theorem}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-141"><strong>(\#thm:unnamed-chunk-141) </strong></span>Sea $f$ una función medible Lebesgue (o medible Borel) definida en el intervalo $[a,b]$. Si $f$ es finita en casi todo punto, entonces para todo $\epsilon>0$, existe una función escalera $g$ y una función continua $h$ tales que $$|f-g|<\epsilon\mbox{ y } |f-h|<\epsilon$$ salvo en un conjunto de medida menor que $\epsilon$. Además, si existen $m, M\in\mathbb{R}$ tales que $m\leq f\leq M$, entonces $g$ y $h$ se pueden elegir acotadas por $m$ y $M$, es decir, $m\leq g,h\leq M$.
</div>\EndKnitrBlock{theorem}
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-142"><strong>(\#def:unnamed-chunk-142) </strong></span>Sea $f:\mathbb{R}\longrightarrow\mathbb{R}^{+}$ una función simple no negativa, $$f=\sum_{i=1}^{n} k_{i}\chi_{A_{i}}\mbox{ con } A_{i}\in\mathcal{M} \mbox{ disjuntos dos a dos y } k_{i}\geq 0\mbox{ escalares }$$ 
...
\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}Dado un conjunto medible $A$, se tiene que $\int_{\mathbb{R}} \chi_{A}=m(A)$.
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-144"><strong>(\#def:unnamed-chunk-144) </strong></span>Diremos que una función simple no negativa $f$ es *integrable-Lebesgue* cuando $\int_{\mathbb{R}} f$ sea finita.
</div>\EndKnitrBlock{definition}

\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-145"><strong>(\#exm:unnamed-chunk-145) </strong></span>La función indicatriz del conjunto de los racionales del intervalo $[0,1]$, es integrable-Lebesgue. Efectivamente, $$\int_{\mathbb{R}} \chi_{\mathbb{Q}\cap[0,1]}=m(\mathbb{Q}\cap[0,1])=0.$$
Como también lo es $\chi_{[0,1]\backslash\mathbb{Q}}$.
</div>\EndKnitrBlock{example}

\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-146"><strong>(\#exm:unnamed-chunk-146) </strong></span>La función $\chi_{\mathbb{R}}$ no es integrable-Lebesgue, ya que $m(\mathbb{R})=\infty$. Así como tampoco lo es $\chi_{[0,\infty)}$.
</div>\EndKnitrBlock{example}
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:prop36"><strong>(\#prp:prop36) </strong></span>Sean $f$ y $g$ funciones simples no negativas y $\lambda\in\mathbb{R}$ un escalar no negativo. Entonces 
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-147"><strong>(\#prp:unnamed-chunk-147) </strong></span>Sean $f$ y $g$ funciones no negativas, entonces

(i.) $\int_{\mathbb{R}} f\geq 0$,

(ii.) si $f\geq g$, entonces $\int_{\mathbb{R}} f\geq \int_{\mathbb{R}} g$.
</div>\EndKnitrBlock{proposition}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}De la definición de integral de Lebesgue, se tiene directamente que $\int_{\mathbb{R}} f\geq 0$. Considerando $g-f$, se sigue el resultado ii.
</div>\EndKnitrBlock{proof}

\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-149"><strong>(\#def:unnamed-chunk-149) </strong></span>Dados $f:\mathbb{R}\longrightarrow\mathbb{R}$ una función simple no negativa y un conjunto medible $A\in\mathbb{M}$, definimos \textit{la integral de Lebesgue de $f$ sobre $A$} como sigue:
	$$\int_{A} f=\int_{\mathbb{R}} f \chi_{A}.$$ 
</div>\EndKnitrBlock{definition}

\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-150"><strong>(\#prp:unnamed-chunk-150) </strong></span>Sea $f:\mathbb{R}\longrightarrow\mathbb{R}$ una función simple no negativa, se tiene $$\int_{A} f\leq \int_{\mathbb{R}} f.$$
</div>\EndKnitrBlock{proposition}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Basta notar que $f \chi_{A}\leq f$.
</div>\EndKnitrBlock{proof}
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-152"><strong>(\#def:unnamed-chunk-152) </strong></span>Dadas una función medible no negativa $f$ y una sucesión creciente de funciones simples no negativas que la aproximan, esto es, $\lim\limits_{n} f_{n}(x)=f(x)$. La *integral de Lebesgue de la función $f$* es
...
\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}Se puede probar que si $\{g_{n}\}$ es otra sucesión creciente de funciones simples no negativas, tal que $\lim\limits_{n} g_{n}(x)=f(x)$ (puntual en casi todo punto) entonces $\lim\limits_{n\to\infty} \int_{\mathbb{R}} g_{n}=\lim\limits_{n\to\infty} \int_{\mathbb{R}} f_{n}$.
</div>\EndKnitrBlock{remark}

\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-154"><strong>(\#prp:unnamed-chunk-154) </strong></span>Si $f:\mathbb{R}\longrightarrow \overline{\mathbb{R}}$ es medible Lebesgue no negativa, entonces
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-155"><strong>(\#prp:unnamed-chunk-155) </strong></span>Sean $f, g:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ medibles Lebesgue no negativas. Sea $\lambda\geq 0$ un escalar, entonces 
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-156"><strong>(\#def:unnamed-chunk-156) </strong></span>Decimos que una función $f:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ medible Lebesgue no negativa, es *integrable Lebesgue en $\mathbb{R}$* cuando $\int_{\mathbb{R}} f$ es finita. 
</div>\EndKnitrBlock{definition}

\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-157"><strong>(\#prp:unnamed-chunk-157) </strong></span>Sea $f:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ una función medible Lebesgue no negativa. Si $f$ es integrable Lebesgue en $\mathbb{R}$, entonces $f$ es finita en casi todo punto.
</div>\EndKnitrBlock{proposition}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Sea $A=\{x\in\mathbb{R}: f(x)=+\infty \}$. Para cualquier $n\in\mathbb{N}$, se tiene que $f(x)\geq n$ siempre que $x\in A$. Entonces,	$$n m(A)=n\int_{\mathbb{R}} \chi_{A}=\int_{\mathbb{R}} n\chi_{A}\leq\int_{\mathbb{R}} f.$$
	De donde se tiene que 
	$$0\leq m(A)\leq\frac{1}{n}\int_{\mathbb{R}} f$$
	para todo $n\in\mathbb{R}$. Por lo tanto se tiene que $m(A)=0$.
</div>\EndKnitrBlock{proof}

\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-159"><strong>(\#def:unnamed-chunk-159) </strong></span>Sea $f:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ una función medible Lebesgue no negativa y sea $A\in\mathcal{M}$ un conjunto medible Lebesgue. Definimos *la integral de Lebesgue de $f$ en $A$* como $$\int_{A} f=\int_{\mathbb{R}} f \chi_{A}.$$
Y decimos que \textit{$f$ es integrable en $A$} cuando $\int_{A} f$ es finita.
</div>\EndKnitrBlock{definition}

\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}Se puede demostrar que si $f$ es una función medible Lebesgue no negativa, entonces $\int_{A} f\leq \int_{\mathbb{R}} f$.
</div>\EndKnitrBlock{remark}

\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-161"><strong>(\#prp:unnamed-chunk-161) </strong></span>Sea $f:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ medible Lebesgue no negativa. Si $A\in\mathcal{M}$ es un conjunto de medida nula, entonces $\int_{A} f=0$. 
</div>\EndKnitrBlock{proposition}
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-164"><strong>(\#prp:unnamed-chunk-164) </strong></span>Sea $f:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ una función medible Lebesgue. $f$ es integrable Lebesgue si y solo si $|f|$ es integrable Lebesgue. Además, $$|\int_{\mathbb{R}} f|\leq \int_{\mathbb{R}} |f|.$$
</div>\EndKnitrBlock{proposition}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Por la linealidad de la integral y como $f=f^{+}-f^{-}$, se tiene que $f$ es integrable Lebesgue si y solo si $f^{+}$ y $f^{-}$ lo son.
...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-166"><strong>(\#exm:unnamed-chunk-166) </strong></span>Sea $f_{n}=n\chi(0,\frac{1}{n})$, para cada $n\in\mathbb{N}$. Es claro que $f_{n}\rightarrow 0$   cuando $n\to\infty$. Por lo tanto $\int_{\mathbb{R}} \lim\limits_{n\to\infty} f_{n}=0$. Pero $\int_{\mathbb{R}} f_{n}=1$ por lo que $\lim\limits_{n\to\infty} \int_{\mathbb{R}} f_{n}=1$.
</div>\EndKnitrBlock{example}
...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-167"><strong>(\#exm:unnamed-chunk-167) </strong></span>Sea $f_{n}=\frac{1}{n}\chi[0,n]$, para cada $n\in\mathbb{N}$. En este caso $f_{n}\rightarrow 0$   cuando $n\to\infty$. Por lo tanto $\int_{\mathbb{R}} \lim\limits_{n\to\infty} f_{n}=0$. Pero $\int_{\mathbb{R}} f_{n}=1$ por lo que $\lim\limits_{n\to\infty} \int_{\mathbb{R}} f_{n}=1$.
</div>\EndKnitrBlock{example}
...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-169"><strong>(\#exm:unnamed-chunk-169) </strong></span>Sea $f_{n}=\chi_{[n,\infty)}$. $f_{n}$ tiende a $0$ puntualmente y es una sucesión decreciente. Para cada $n$, $\int_{\mathbb{R}} f_{n}=m([n,\infty))=\infty$ por lo tanto, $\lim\limits_{n\to\infty}\int_{\mathbb{R}} f_{n}=\infty$ pero $\int_{\mathbb{R}}\lim\limits_{n\to\infty} f_{n}=0$.
</div>\EndKnitrBlock{example}

\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}Bajo las hipótesis del teorema de Beppo-Levy, se puede deducir lo siguiente:
...
\BeginKnitrBlock{corollary}<div class="corollary"><span class="corollary" id="cor:unnamed-chunk-171"><strong>(\#cor:unnamed-chunk-171) </strong></span>Sea $\{f_{n}\}_{n}$ una sucesión de funciones medibles Lebesgue no negativas, $f_{n}:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$. Sea $f(x)=\sum_{n=1}^{\infty} f_{n}(x)$. Entonces $\int_{\mathbb{R}}f=\sum_{n=1}^{\infty}\int_{\mathbb{R}} f_{n}$.
</div>\EndKnitrBlock{corollary}

\BeginKnitrBlock{lemma}\iffalse{-91-70-97-116-111-117-93-}\fi{}<div class="lemma"><span class="lemma" id="lem:unnamed-chunk-172"><strong>(\#lem:unnamed-chunk-172)  \iffalse (Fatou) \fi{} </strong></span>Sea $\{f_{n}\}_{n}$ una sucesión de funciones medibles Lebesgue no negativas, $f_{n}:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$. Entonces
$$\int_{\mathbb{R}}\liminf_{n\to\infty} f_{n}\leq \liminf_{n\to\infty} \int_{\mathbb{R}} f_{n}.$$
</div>\EndKnitrBlock{lemma}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Para cada $n\in\mathbb{N}$, sea $g_{n}=\inf\limits_{k\geq n} f_{k}$. Entonces para cada $n$, $0\geq g_{n}\geq f_{n}$, $\{g_{n}\}_{n}$ es una sucesión creciente de funciones medibles Lebesgue y $\lim\limits_{n\to\infty} g_{n}=\liminf\limits_{n\to\infty} f_{n}$. Por el teorema de Beppo-Levy @ref{thm:BeppoLevy} (convergencia monótona) se tiene que
...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-174"><strong>(\#exm:unnamed-chunk-174) </strong></span>Consideremos la siguiente sucesión, para cada $n$, sea $f_{n}:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$, definida así
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-175"><strong>(\#def:unnamed-chunk-175) </strong></span>Sea $f:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ una función medible Lebesgue. Decimos que *$f$ es integrable Lebesgue en $\mathbb{R}$* si y solo si $f^{+}$ y $f^{-}$ son integrables Lebesgue en $\mathbb{R}$ y definimos 
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-176"><strong>(\#prp:unnamed-chunk-176) </strong></span>Sean $f,g:\mathbb{R}\longleftrightarrow\overline{\mathbb{R}}$ funciones integrables Lebesgue en $\mathbb{R}$ y $\lambda\in\mathbb{R}$, entonces:
...
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Las parte $i$, $iii$ y $iv$ siguen derectamente de las propiedades de la integral de Lebesgue para funciones no negativas. Para la parte $ii$ basta notar que $f^{+}=\frac{|f|+f}{2}$, de este modo
	$$(f+g)^{+}\geq f^{+} +g^{+},$$
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-178"><strong>(\#prp:unnamed-chunk-178) </strong></span>Sea $f:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ medible Lebesgue. Se tiene que $f$ es integrable Lebesgue en $\mathbb{R}$ si y solo si $|f|$ es integrable Lebesgue en $\mathbb{R}$, además $$\left| \int_{\mathbb{R}} f\right| \leq\int_{\mathbb{R}} |f|.$$
</div>\EndKnitrBlock{proposition}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}	Como $f=f^{+}-f^{-}$, de la desigualdad triangular y la linealidad de la integral, se sigue el resultado.
\end{proof}
...
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}La parte $i$ se deduce inmediantamente de la monotonía de la integral, ya que $f\chi_{A}\leq f$. Para demostrar $ii$ solo basta notar que si $A\cap B=\emptyset$ entonces $\chi_{A\cup B}=\chi_{A}+\chi_{B}$. Por último, sea $N=\{x\in\mathbb{R}: |f|=\infty\}$, entonces para todo $n\in\mathbb{N}$ y todo $x\in N$, se tiene que $|f(x)|>n$. Por otro lado, por la parte anterior, se tiene que $$\int_{\mathbb{R}}|f|=\int_{N} |f| +\int_{N^{C}} |f|$$
entonces
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:prop434"><strong>(\#prp:prop434) </strong></span>Sea $f:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ medible Lebesgue. Si $A\in\mathcal{M}$ es un conjunto de medida cero. Entonces $f$ es integrable Lebesgue en $A$ y $$\int_{A} f=0.$$
</div>\EndKnitrBlock{proposition}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Por monotonía de la medida de Lebesgue, cualquier subconjunto de $A$ tiene medida nula. De donde se tiene que $f=0$ en casi todo punto de $A$, de donde se sigue fácilmente el resultado.
</div>\EndKnitrBlock{proof}

\BeginKnitrBlock{proposition}\iffalse{-91-68-101-115-105-103-117-97-108-100-97-100-32-100-101-32-67-104-101-98-121-99-104-111-118-93-}\fi{}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-182"><strong>(\#prp:unnamed-chunk-182)  \iffalse (Desigualdad de Chebychov) \fi{} </strong></span>Sea $f:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ medible Lebesgue. Si $|f|\geq\lambda> 0$ en $A\in\mathcal{M}$. Entonces $$\lambda m(A)\geq\int_{\mathbb{R}} |f|.$$.
</div>\EndKnitrBlock{proposition}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Como $$\int_{\mathbb{R}}|f|\geq \int_{A}|f|\geq \lambda m(A).$$
</div>\EndKnitrBlock{proof}

\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-184"><strong>(\#prp:unnamed-chunk-184) </strong></span>Sea $f:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ medible Lebesgue. Entonces:
...
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Supongamos que $f\geq 0$ y que $\int_{\mathbb{R}}=0$. Sea $A=\{x\in\mathbb{R}: |f|\geq n\}$  para cualquier $n\in\mathbb{N}$. De la desigualdad de Chebychov, se tiene que $$m(A)\geq \frac{1}{n}\int_{\mathbb{R}} |f|=\frac{1}{n} \int_{\mathbb{R}} f$$ por lo tanto $m(A)=0$. Para demostar la parte $ii$, consideremos el conjunto $A=\{x\in\mathbb{R}: f(x)\neq g(x) \}$, entonces $m(A)=0$. Entonces, por la proposición \@ref{prp:prop434}
...
\BeginKnitrBlock{theorem}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-186"><strong>(\#thm:unnamed-chunk-186) </strong></span>Sea $f:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ integrable Lebesgue y sea $\epsilon>0$, entonces existe $\delta>0$ tal que $$m(A)\leq\delta\Rightarrow \left| \int_{A} f\right| \leq \int_{A}|f|<\epsilon.$$
</div>\EndKnitrBlock{theorem}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Si $f$ es acotada, digamos por $M\in\mathbb{R}$, entonces $\int_{A}|f|\leq \int_{A} M=M m(A)\leq M\delta$. Luego, tomando $\epsilon\geq M\delta$, se tiene el resultado.
...
\BeginKnitrBlock{corollary}<div class="corollary"><span class="corollary" id="cor:unnamed-chunk-188"><strong>(\#cor:unnamed-chunk-188) </strong></span>Sean $\{f_{n}\}_{n}$ una sucesión de funciones $f_{n}:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ medibles Lebesgue. Sea $g:\longrightarrow\mathbb{R}$ una función integrable Lebesgue tal que $f_{n}\geq g$ casi siempre. Entonces $$\int_{\mathbb{R}} \liminf\limits_{n\to\infty} f_{n}\leq \liminf\limits_{n\to\infty} \int_{\mathbb{R}} f_{n}.$$
</div>\EndKnitrBlock{corollary}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Definamos $h_{n}=f_{n}-g$, entonces $h_{n}\geq 0$ c.s. Por el teorema de Fatou,
...
\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}El Lema de Fatou es falso si la sucesión $\{f_{n}\}_{n}$ no está dominada inferiormente. Veamos esto con un ejemplo.
</div>\EndKnitrBlock{remark}

\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-191"><strong>(\#exm:unnamed-chunk-191) </strong></span>Consideremos la siguiente sucesión de funciones integrables Lebesgue,
$$f_{n}(x)=\left\lbrace\begin{array}{ll}
...
\BeginKnitrBlock{corollary}<div class="corollary"><span class="corollary" id="cor:unnamed-chunk-192"><strong>(\#cor:unnamed-chunk-192) </strong></span>Sean $\{f_{n}\}_{n}$ una sucesión de funciones $f_{n}:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ medibles Lebesgue dominada superiormente por una función integrable Lebesgue $g:\longrightarrow\mathbb{R}$, es decir,$f_{n}\leq g$. Entonces $$\int_{\mathbb{R}} \limsup\limits_{n\to\infty} f_{n}\geq \limsup\limits_{n\to\infty} \int_{\mathbb{R}} f_{n}.$$
</div>\EndKnitrBlock{corollary}

## Teoremas de Aproximación

\BeginKnitrBlock{theorem}\iffalse{-91-67-111-110-118-101-114-103-101-110-99-105-97-32-100-111-109-105-110-97-100-97-32-100-101-32-76-101-98-101-115-103-117-101-93-}\fi{}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-193"><strong>(\#thm:unnamed-chunk-193)  \iffalse (Convergencia dominada de Lebesgue) \fi{} </strong></span>	Sea $\{f_{n}\}_{n}$ una sucesión de funciones $f_{n}:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ medibles Lebesgue, tales que $\lim\limits_{n\to\infty} f_{n}(x)=f(x)$ c.s. Sea $h:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ integrable Lebesgue tal que para todo $n\in\mathbb{N}$, $|f_{n}(x)|\leq h(x)$ c.s. Entonces:
...
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Como $|f_{n}|\leq h$, para todo $n$, se tiene que cada $|f_{n}|$ es integrable Lebesgue y por lo tanto, cada $f_{n}$ también lo es.
...
\BeginKnitrBlock{corollary}<div class="corollary"><span class="corollary" id="cor:unnamed-chunk-195"><strong>(\#cor:unnamed-chunk-195) </strong></span>Sea $\{f_{n}\}_{n}$ una sucesión de funciones $f_{n}:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ medibles Lebesgue, tales que $\lim\limits_{n\to\infty} f_{n}(x)=f(x)$. Sea $A\in\mathcal{M}$ un conjunto de medida finita y supongamos que existe $M\in\mathbb{R}$ tal que $|f_{n}(x)|\leq M$ para todo $n\in\mathbb{N}$ y todo $x\in A$. Entonces $$\lim\limits_{n\to\infty}\int_{A} f_{n}=\int_{A} f.$$
</div>\EndKnitrBlock{corollary}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Sea $g=M\chi_{A}$. Como $m(A)<\infty$, $g$ es integrable. Ahora, $\{f_{n}\chi_{A}\}_{n}$ y $g$ cumplen con las hipótesis del teorema de convergencia dominada de Lebesgue, por lo tanto
$$\lim\limits_{n\to\infty}\int_{\mathbb{R}} f_{n}\chi_{A}=\int_{\mathbb{R}} f\chi_{A}.$$
</div>\EndKnitrBlock{proof}

\BeginKnitrBlock{corollary}<div class="corollary"><span class="corollary" id="cor:unnamed-chunk-197"><strong>(\#cor:unnamed-chunk-197) </strong></span>Sea $<a,b>$ un intervalo finito cualquiera de $\mathbb{R}$. Y sea $\{f_{n}\}_{n}$ una sucesión de funciones $f_{n}:<a,b>\longrightarrow\mathbb{R}$ medibles Lebesgue. Supongamos que $f_{n}\xrightarrow[n\to\infty]{} f(x)$ en $<a,b>$. Entonces
	$$\int_{a}^{b} |f_{n}-f|\xrightarrow[n\to\infty]{} 0.$$
</div>\EndKnitrBlock{corollary}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Dado $\epsilon>0$, por la convergencia uniforme, existe $N\in\mathbb{N}$ tal que si $n\geq N$ entonces $|f_{n}(x)-f(x)|<\epsilon$ para todo $x\in<a,b>$. Por lo tanto $|f_{n}-f|<\epsilon\chi_{<a,b>}$. Como $\epsilon\chi_{<a,b>}$ es integrable Lebesgue, del teorema de CDL se concluye que $$\lim\limits_{n\to\infty}\int_{a}^{b}|f_{n}-f|=0.$$
</div>\EndKnitrBlock{proof}
...
\BeginKnitrBlock{theorem}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-199"><strong>(\#thm:unnamed-chunk-199) </strong></span>Sea $<a,b>$ un intervalo finito cualquiera de números reales. Sea $f(x,t)$, con $x\in\mathbb{R}$ y $t\in<a,b>$, una función de dos variables tal que para cada $t$ fijo, la función $x\mapsto f(x,t)$ es medible Lebesgue. Supongamos que 
...
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Supongamos que $\lim\limits_{t\to b^{-}} f(x,t)=f(x)$. Sea $(t_{n})_{n}$ una sucesión de números reales en $(a,b)$ tal que $t_{n}\longrightarrow$. Consideremos la sucesión de funciones $f_{n}=f(x,t_{n})$, por el teorema de convergencia dominada de Lebesgue, se sigue que
...
\BeginKnitrBlock{theorem}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-201"><strong>(\#thm:unnamed-chunk-201) </strong></span>Sean $-\infty\leq a<b\leq +\infty$. Para cada $t\in(a,b)$, sea $f_{t}:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ una función medible Lebesgue. Entonces, si para todo $t\in(a,b)$, $|f_{t}|\leq g$, donde $g$ es una función integrable Lebesgue y $f_{t}\to f$ cuando $t\to a^{+}$ o $t\to b^{-}$. Entonces $f$ es integrable Lebesgue y 
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-202"><strong>(\#def:unnamed-chunk-202) </strong></span>Sea $\{f_{n}\}_{n}$ una sucesión de funciones $f_{n}:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ medibles Lebesgue. Sea $E\in\mathcal{M}$. 
...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-203"><strong>(\#exm:unnamed-chunk-203) </strong></span>La sucesión de las funciones $f_{n}(x)=x^{n}\chi_{[0,1]}$ converge puntualmente a la función $$f(x)=\left\lbrace\begin{array}{ll}
	0&\mbox{ si } 0\leq x<1\\
	1&\mbox{ si } x=1
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-204"><strong>(\#def:unnamed-chunk-204) </strong></span>Decimos que $\{f_{n}\}_{n}$ *converge casi uniformemente* a una función $f$ en un conjunto medible $E$, si y solo si $\forall\epsilon>0$, existe $F\subseteq E$ tal que $\{f_{n}\}_{n}$ converge uniformemente a $f$ en $F$ y $m(E\backslash F)=0$. Se escribe $f_{n}\to f$ c.u. en $E$.
</div>\EndKnitrBlock{definition}

\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}Es claro que la convergencia uniforme implica la convergencia casi uniforme. Pero el recíproco no es cierto.
</div>\EndKnitrBlock{remark}

\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-206"><strong>(\#prp:unnamed-chunk-206) </strong></span>Sea $\{f_{n}\}_{n}$ una sucesión de funciones $f_{n}:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ medibles Lebesgue. Si $f_{n}\to f$ casi uniformemente en un conjunto medible $E$, entonces $f_{n}\to f$ en casi todo punto de $E$.
</div>\EndKnitrBlock{proposition}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Sea $F_{n}\subseteq E$ tal que $f_{n}\to f$ uniformemente en $E\backslash F_{n}$ y $m(F_{n})<\frac{1}{n}$. Tomando $F=\bigcap F_{n}$, se tiene que $m(F)=0$ y $f_{n}(x)\to f(x)$ en c.t.p de $E$.
</div>\EndKnitrBlock{proof}

\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}El recíproco de la proposición anterior, es falso tal como lo muestra el siguiente ejemplo.
</div>\EndKnitrBlock{remark}

\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-209"><strong>(\#exm:unnamed-chunk-209) </strong></span>Sea $f_{n}=\chi_{[n,\infty)}$. Es claro que $f_{n}\to 0$ para todo $x\in\mathbb{R}$ pero $f_{n}$ no converge c.u. a $0$ en $\mathbb{R}$.
</div>\EndKnitrBlock{example}

\BeginKnitrBlock{theorem}\iffalse{-91-69-103-111-114-111-118-180-115-93-}\fi{}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-210"><strong>(\#thm:unnamed-chunk-210)  \iffalse (Egorov´s) \fi{} </strong></span>Sea $E\in\mathcal{M}$ un conjunto de medida finita y sea $\{f_{n}\}_{n}$ una sucesión de funciones medibles $f_{n}:E\longrightarrow\overline{\mathbb{R}}$ tales que, para cada $n\in\mathbb{N}$, $|f_{n}|<\infty$ en c.t.p de $E$. Sea $f:E\longrightarrow\overline{\mathbb{R}}$ una función finita en c.t.p. de $E$. Supongamos que $f_{n}\to f$ en c.t.p. de $E$. Entonces $f_{n}\to f$ c.u. en $E$.
</div>\EndKnitrBlock{theorem}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Sean $A_{n}=\{x\in\mathbb{R}:|f_{n}(x)|=\infty \}$ para cada $n\in\mathbb{N}$, $B=\{x\in\mathbb{R}:|f(x)|=\infty \}$ y $C=\{x\in\mathbb{R}: f_{n}(c)\mbox{ no converge a } f(x) \}$. Llamemos $F=\left( \bigcup_{n\in\mathbb{N}}A_{n}\right) \cup B\cup C$, entonces $m(F)=0$. Sea $\overline{E}=E\backslash F$. Si demostramos que $f_{n}\to f$ c.u. en $\overline{E}$, entonces se tiene que $f_{n}\to f$ c.u. en $E$. Entonces podemos suponer sin pérdida de generalidad que para todo $n\in\mathbb{N}$, $|f_{n}|$ es finita en $E$, que $|f|$ es finita y que $f_{n}\to f$ en $E$.
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-213"><strong>(\#def:unnamed-chunk-213) </strong></span>Una sucesión $(f_{n})_{n\in\mathbb{N}}$ de funciones $f_{n}:\mathbb{R}\longrightarrow\overline{R}$ medibles es *de Cauchy en medida* si y solo si para todo $\epsilon>0$ y todo $\xi>0$, existe $N\in\mathbb{N}$ tal que si $n,m>N$, entonces $m\{x\in\mathbb{R}:|f_{n}(x)-f_{m}(x)|\geq\epsilon\}<\xi.$
</div>\EndKnitrBlock{definition}

\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}La convergencia en casi todo punto no implica, en general, la convergencia en medida, salvo que la convergencia en c.t.p. esté dada en un conjunto de medida finita. El recíproco tampoco es cierto, es decir, la convergencia en medida no implica la convergencia en c.t.p.
</div>\EndKnitrBlock{remark}

\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-215"><strong>(\#exm:unnamed-chunk-215) </strong></span>La sucesión $\chi_{[n,\infty)}(x)$ converge puntualmente (por lo tanto, en casi todo punto) a la función $f=0$. Pero	$$m\{x\in\mathbb{R}:|f_{n}(x)-f(x)|\geq \epsilon \}=m[n,\infty)=\infty\mbox{, para cualquier } \epsilon<1$$ por lo tanto, la sucesión no converge en medida.
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-216"><strong>(\#prp:unnamed-chunk-216) </strong></span>Sea $(f_{n})_{n\in\mathbb{N}}$ una sucesión de funciones medibles finitas en c.t.p. que converge en medida a una función medible $f$. Entonces, existe una subsucesión $(f_{n_{k}})_{k\in\mathbb{N}}$ tal que $f_{n_{k}}\xrightarrow{k\to\infty} f$ en c.t.p.
</div>\EndKnitrBlock{proposition}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Como $f_{n}\xrightarrow{m} f$, para todo $k\in\mathbb{N}$, existe $n_{k}$ tal que si $n\geq n_{k}$, entonces $$m\{x\in\mathbb{R}: |f_{n}(x)-f(x)|\geq \frac{1}{2^{k}} \}<\frac{1}{2^{k}}.$$
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-218"><strong>(\#prp:unnamed-chunk-218) </strong></span>$L^{p}$ es un espacio vectorial.
</div>\EndKnitrBlock{proposition}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Basta notar que $|f+g|^{p}\leq 2^{p}\max(|f|^{p},|g|^{p})\leq 2^{p}(|f|^{p}+|g|^{p})$. De las propiedades de la integral se obtiene el resultado.
</div>\EndKnitrBlock{proof}
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-220"><strong>(\#prp:unnamed-chunk-220) </strong></span>$\|f\|_{p}$ es una pseudo-norma en el espacio $L^{p}$, esto es:
...
\BeginKnitrBlock{lemma}<div class="lemma"><span class="lemma" id="lem:unnamed-chunk-221"><strong>(\#lem:unnamed-chunk-221) </strong></span>Sean $a, b\geq 0$ números reales y $\frac{1}{p}+\frac{1}{q}=1$, con $p,q\in\mathbb{N}$ no núlos. Entonces $ab\leq\frac{a^{p}}{p}+\frac{b^{q}}{q}$. Además, si $b=a^{p-1}$, se tiene la igualdad.
</div>\EndKnitrBlock{lemma}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Sea $\phi(t)$ una función continua estrictamente creciente en $[0,\infty)$ que toma valor cero en cero, es decir,  $\phi(0)=0$. Sea $(a,b)$ un punto del plano ( con $a$ y $b$ como en las hipótesis). Entonces
...
\BeginKnitrBlock{theorem}\iffalse{-91-68-101-115-105-103-117-97-108-100-97-100-32-100-101-32-72-246-108-100-101-114-93-}\fi{}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-223"><strong>(\#thm:unnamed-chunk-223)  \iffalse (Desigualdad de Hölder) \fi{} </strong></span>Sean $1<p,q<\infty$ tales que $\frac{1}{p}+\frac{1}{q}=1$. Entonces, si $f\in L^{p}$ y $g\in L^{q}$, se tiene que $fg\in L^{1}$ y $$\int|fg|\leq \|f\|_{p}\|g\|_{q}.$$
Además, $$\int|fg|=\|f\|_{p}+\|g\|_{q}\mbox{ si y solo si existen constantes } c,d\in\mathbb{R}\mbox{ tales que } c|f|^{p}=d|g|^{q}.$$
</div>\EndKnitrBlock{theorem}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Podemos suponer que $\|f\|_{p}>0$ y $\|g\|_{q}>0$, ya que en ese caso, $f=0$ c.s y $g=0$ c.s. de donde se obtiene el resultado fácilmente. Más aún, podemos suponer que $\|f\|_{p}=1$ y $\|g\|_{q}=1$, pues en otro caso, tomando $\hat{f}=\frac{f}{\|f\|_{p}}$ y $\hat{g}=\frac{g}{\|g\|_{q}}$, se obtiene el resultado.
...
\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}Si $p=q=2$, la desigualdad anterior es la llamada *desigualdad de Cauchy-Schwarz*, esta es 
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-226"><strong>(\#prp:unnamed-chunk-226) </strong></span>Sean $p$ y $q$ índices conjugados. Entonces:
...
\BeginKnitrBlock{theorem}\iffalse{-91-68-101-115-105-103-117-97-108-100-97-100-32-100-101-32-77-105-110-107-111-119-115-107-105-93-}\fi{}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-227"><strong>(\#thm:unnamed-chunk-227)  \iffalse (Desigualdad de Minkowski) \fi{} </strong></span>Si $f,g\in L^{p}$ (con $p\geq 1$) entonces $\|f+g\|_{p}\leq \|f\|_{p}+\|g\|_{p}.$
</div>\EndKnitrBlock{theorem}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Si $p=1$, de la desigualdad triangular se sigue que $\int |f+g|\leq \int |f| +\int |g|$.
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-229"><strong>(\#def:unnamed-chunk-229) </strong></span>Sea $(f_{n})_{n}$ una sucesión de funciones en $L^{p}$. Decimos que $(f_{n})_{n}$ *converge en norma $p$* a una función $f\in L^{p}$ si y solo si $\|f_{n}-f\|\xrightarrow[n\to\infty]{}0$. Es decir $\int |f_{n}-f|^{p}\xrightarrow[n\to\infty]{}0$. Lo que se denota $f_{n}\xrightarrow[\|\,\|_{p}]{} f$.
</div>\EndKnitrBlock{definition}
...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:ejemplo522"><strong>(\#exm:ejemplo522) </strong></span>Considere la sucesión $f_{n}=n\chi_{(0,\frac{1}{n})}$. Se tiene que para todo $\epsilon>0$, $m(\{x\in\mathbb{R}:|f_{n}(x)|\geq\epsilon \})=\frac{1}{n}\xrightarrow[n\to\infty]{}0$ pero $\int|f|^{p}=n^{p-1}\xrightarrow[n\to\infty]{}\infty$, por lo tanto $f_{n}$ no converge a $0$ en norma $p$.
</div>\EndKnitrBlock{example}

\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}La relación entre los tipos de convergencia:
...
\BeginKnitrBlock{theorem}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-231"><strong>(\#thm:unnamed-chunk-231) </strong></span>Sea $p\geq 1$ y sea $(f_{n})_{n}$ una sucesión de funciones medibles Lebesgue tal que existe una función $h$ tal que $|f_{n}|^{p}\leq h$ c.s. Si se cumplen alguna de las siguientes:
...
\BeginKnitrBlock{theorem}\iffalse{-91-82-105-101-115-122-45-70-105-115-99-104-101-114-93-}\fi{}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-232"><strong>(\#thm:unnamed-chunk-232)  \iffalse (Riesz-Fischer) \fi{} </strong></span>Sea $1\leq p<\infty$. Si $(f_{n})_{n\geq 1}$ es de Cauchy en $L^{p}$, entonces existe $f$ en $L^{p}$ tal que $\|f_{n}-f\|_{p}\xrightarrow[n\to\infty]{}0$.
</div>\EndKnitrBlock{theorem}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Como $(f_{n})_{n}$ es una sucesión de Cauchy en $L^{p}$, entonces es de Cauchy en medida. Por lo tanto existe una función medible Lebesgue $f$ tal que $f_{n}\xrightarrow{m} f$. Luego, existe una subsucesión $(f_{n_{k}})_{k}$ que converge a $f$ c.s. lo que implica, por el lema de Fatou, que 
...
\BeginKnitrBlock{corollary}<div class="corollary"><span class="corollary" id="cor:unnamed-chunk-234"><strong>(\#cor:unnamed-chunk-234) </strong></span>$\mathcal{L}^{p}$ es un espacio de Banach.
</div>\EndKnitrBlock{corollary}

## Espacios $L^{\infty}$

\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-235"><strong>(\#def:unnamed-chunk-235) </strong></span>Diremos que una función $f:\mathbb{R}\longrightarrow\overline{\mathbb{R}}$ es *esencialmente acotada* si existe $a\in\mathbb{R}$, $0<a$ tal que $m\{x\in\mathbb{R}: |f(x)|>a \}=0$. En este caso, decimos que $a$ es *una cota esencial de $f$*. Y definimos el *supremo esencial de $f$*, denotado por $sup.es.|f|$ como el ínfimo del conjunto de cotas esenciales, es decir, 
	$$sup.es.|f|=\inf\{a\in\mathbb{R}:m\{x\in\mathbb{R}: |f(x)|>a \}=0\}.$$
</div>\EndKnitrBlock{definition}

\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}Note que $sup.es.|f|$ es una cota esencial de $f$. Además, si $C=sup.es.|f|$, entonces $m\{x\in\mathbb{R}:|f(x)|>C \}=0$ por lo que $|f(x)|<C$ en c.s.
</div>\EndKnitrBlock{remark}
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-237"><strong>(\#prp:unnamed-chunk-237) </strong></span>Si $f\in L^{1}$, $g\in L^{\infty}$; entonces $|fg|\in L^{1}$ y $$\int |fg|=\|f\|_{1}\|g\|_{\infty}.$$
</div>\EndKnitrBlock{proposition}
...
\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}Para culminar esta sección, haremos las siguientes precisiones:
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-239"><strong>(\#def:unnamed-chunk-239) </strong></span>Sea $X$ un espacio vectorial (sobre $\mathbb{R}$). Un *producto interno* en $X$ es una función $(\cdot,\cdot):X\times X\longrightarrow\mathbb{R}$ que cumple:
...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:ejemplo532"><strong>(\#exm:ejemplo532) </strong></span>La función $(f,g)\mapsto \int_{a}^{b}f(t)g(t)dt$ es un producto interno en $\mathcal{L}^{2}$.
</div>\EndKnitrBlock{example}
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-240"><strong>(\#def:unnamed-chunk-240) </strong></span>Dado un espacio vectorial $X$ con producto interno, decimos que $X$ es un *espacio de Hilbert* si $X$ es completo respecto a la norma inducida por el producto interno.
</div>\EndKnitrBlock{definition}

\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-241"><strong>(\#exm:unnamed-chunk-241) </strong></span>$\mathbb{R}^{n}$ es un espacio de Hilbert con el producto interno $$(x,y)=\sum_{i=1}^{n} x_{i}y_{i}$$
donde $x=(x_{1},\cdots,x_{n})$ y $y=(y_{1},\cdots,y_{n})$.
</div>\EndKnitrBlock{example}

\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-242"><strong>(\#exm:unnamed-chunk-242) </strong></span>$\mathcal{L}^{2}$ es un espacio de Hilbert, con el producto interno definido en el ejemplo \@ref{exm:ejemplo532}.
</div>\EndKnitrBlock{example}

\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-243"><strong>(\#exm:unnamed-chunk-243) </strong></span>Sea $l^{2}$ el conjunto de sucesiones de numeros reales de cuadrados convergentes, es decir, $\sum_{i\in\mathbb{N}} |x_{i}|^{2}<\infty$. La función $(x,y)=\sum_{i=1}^{n}x_{i}y_{i}$, con $x=(x_{n})_{n},  y=(y_{n})_{n}\in l^{2}$ es un producto interno. Se puede demostrar que $l^{2}$ junto a esta función es un espacio de Hilbert. 
</div>\EndKnitrBlock{example}

\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-244"><strong>(\#prp:unnamed-chunk-244) </strong></span>Sea $X$ un espacio con producto interno. Dados $x,y\in X$, se cumple que $$|(x,y)|^{2}\leq (x,x)(y,y)$$
</div>\EndKnitrBlock{proposition}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Por definición de producto interno,
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-246"><strong>(\#def:unnamed-chunk-246) </strong></span>Sea $\mathcal{H}$ un espacio de Hilbert. Un conjunto $E\subseteq \mathcal{H}$ es *linealmente independiente* si todos sus subconjuntos finitos lo son.
</div>\EndKnitrBlock{definition}

\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-247"><strong>(\#def:unnamed-chunk-247) </strong></span>Sea $C\subseteq \mathcal{H}$ se llama *sistema ortogonal* si $(x,y)=0$ para todo $x,y\in A$. Si además se cumple que $\|x\|=1$ para todo $x\in C$, se dice que el sistema $C$ es *ortonormal*.
</div>\EndKnitrBlock{definition}

Es obvio que todo sistema ortogonal es linealmente independiente.

\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-248"><strong>(\#def:unnamed-chunk-248) </strong></span>Dado un conjunto $C\subseteq\mathcal{H}$, el conjunto de todas las *combinaciones lineales finitas* de $C$ lo denotamos por  $$S(C)=\left\lbrace \sum_{i=1}^{n} c_{i}x_{i}: n\in\mathbb{N}, c_{i}\in\mathbb{R}\mbox{ y } x_{i}\in C \right\rbrace .$$
...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-249"><strong>(\#exm:unnamed-chunk-249) </strong></span>Definamos las siguientes funciones en $L^{2}[0,1]$, para cada $n\in\mathbb{N}$
...
\BeginKnitrBlock{theorem}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-250"><strong>(\#thm:unnamed-chunk-250) </strong></span>Sea $\mathcal{H}$ un espacio de Hilbert. Si $\mathcal{H}$ es separable, es decir, contiene un subconjunto denso numerable; entonces todo sistema ortogonal en $\mathcal{H}$ es numerable.
</div>\EndKnitrBlock{theorem}

\BeginKnitrBlock{theorem}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-251"><strong>(\#thm:unnamed-chunk-251) </strong></span>Sea $\mathcal{H}$ un espacio de Hilbert separable. Entonces $\mathcal{H}$ posee un sistema ortonormal completo.
</div>\EndKnitrBlock{theorem}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Sea $(x_{n})_{n}$ un subconjunto denso numerable de $\mathcal{H}$. Consideremos el subconjunto $(y_{n})_{n}\subseteq (x_{n})_{n}$ linealmente independiente maximal. Es claro que $(y_{n})_{n}$ es un sistema completo. Aplicando el proceso de ortogonalización de Gram-Schmidt y normalizando, se obtiene en sistema ortonormal completo.
</div>\EndKnitrBlock{proof}

\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-253"><strong>(\#exm:unnamed-chunk-253) </strong></span>La familia $1, \cos x, \sen x,\cdots, \cos nx, \sen nx,\cdots$ es un sistema ortogonal completo. Y $\frac{1}{\sqrt{2\pi}},\frac{1}{\sqrt{\pi}}\cos x,\frac{1}{\sqrt{\pi}}\sen x, \cdots,\frac{1}{\sqrt{\pi}}\cos nx,\frac{1}{\sqrt{\pi}}\sen nx, \cdots$ es un sistema ortonormal completo.
</div>\EndKnitrBlock{example}

\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:unnamed-chunk-254"><strong>(\#exm:unnamed-chunk-254) </strong></span>Los **polinomios de Legendre** $P_{n}(x)=\frac{1}{2^{n}n!}\frac{d^{n}}{dx^{n}}[(x^{2}-1)^{n}]$ con $n=0,1,2,\cdots$ son ortogonales en $L^{2}[-1,1]$. La familia $\sqrt{\frac{1}{2}(2n+1)}P_{n}(x)$ es una familia ortonormal.
</div>\EndKnitrBlock{example}

\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-255"><strong>(\#def:unnamed-chunk-255) </strong></span>Sea $\mathcal{H}$ un espacio de Hilbert separable y sea $(\phi_{n})_{n\in\mathbb{N}}$ un sistema ortonormal en $\mathcal{H}$. Sea $x\in\mathcal{H}$, los *coeficientes de Fourier* de $x$ respecto del sistema $(\phi_{n})_{n\in\mathbb{N}}$ se definen como sigue:
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-256"><strong>(\#prp:unnamed-chunk-256) </strong></span>Sea $(\phi_{n})_{n}$ un sistema ortonormal en $H$. Sean $x\in H$ y $\lambda_{1},\cdots, \lambda_{2}$ números reales cualesquiera. Entonces se tiene que 
$$\left\|x-\sum_{i=1}^{n}\widehat{x_{i}}\phi_{i} \right\|\leq \left\|x-\sum_{i=1}^{n}\lambda_{i}\phi_{i} \right\|.$$
</div>\EndKnitrBlock{proposition}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}$$\begin{array}{ll}
...
\BeginKnitrBlock{proposition}\iffalse{-91-68-101-115-105-103-117-97-108-100-97-100-32-100-101-32-66-101-115-115-101-108-93-}\fi{}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-258"><strong>(\#prp:unnamed-chunk-258)  \iffalse (Desigualdad de Bessel) \fi{} </strong></span>Sean $\mathcal{H}$ un espacio de Hilbert separable y $(\phi_{n})_{n}$ un sistema ortonormal en $\mathcal{H}$. Dado $x\in\mathcal{H}$, se tiene que 
$$\sum_{k\in\mathbb{N}} (\widehat{x_{k}})^{2}\leq \|x\|^{2}.$$
</div>\EndKnitrBlock{proposition}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Tal como en la prueba de la proposición anterior, se tiene que 
...
\BeginKnitrBlock{theorem}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-260"><strong>(\#thm:unnamed-chunk-260) </strong></span>Sea $\mathcal{H}$ un espacio de Hilbert y $(\phi_{n})_{n}$ un sistema ortonormal en $\mathcal{H}$. Las siguientes condiciones son equivalentes:
...
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Es claro que $ii$ implica $i$. Ahora, supongamos que $(\phi_{n})$ es un sistema completo. Sea $x\in\mathcal{H}$. Dado $\epsilon>0$, existen $N\in\mathbb{N}$ y $c_{1}, \cdots, c_{N}$ tales que $\sum_{i=1}^{N} c_{i}\phi_{i}$ tal que 
...
\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}La serie $\sum_{i\in\mathbb{N}} (x,\phi_{i})\phi_{i}$ es llamada la serie de Fourier de $x$ respecto del sistema $(\phi_{n})_{n}$.
...
\BeginKnitrBlock{theorem}\iffalse{-91-82-105-101-115-122-45-70-105-115-99-104-101-114-93-}\fi{}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-263"><strong>(\#thm:unnamed-chunk-263)  \iffalse (Riesz-Fischer) \fi{} </strong></span>Sea $(\phi_{n})_{n\in\mathbb{N}}$ un sistema ortonormal en un espacio de Hilbert $\mathcal{H}$. Sea $(\beta_{n})_{n\in\mathbb{N}}$ una sucesión de números reales, tal que $\sum_{n\in\mathbb{N}} \beta^{2}<\infty$. Entonces existe $x\in\mathcal{H}$ cuyos coeficientes de Fourier son $\beta_{n}=(x,\phi_{n})$ y además las sumas parciales $\sum_{i=1}^{n}\beta_{i}\phi_{i}$ convergen a $x$ en norma.
</div>\EndKnitrBlock{theorem}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Sea $S_{n}=\sum_{i=1}^{n}\beta_{i}\phi_{i}$, entonces $\|S_{n+p}-S_{n}\|^{2}=\sum_{i=n+1}^{n+p}\beta_{i}^{2}$, por lo tanto $(S_{n})_{n\in\mathbb{N}}$ es de Cauchy en norma.	Como $\mathcal{H}$ es completo, existe $x\in\mathcal{H}$ tal que $S_{n}\xrightarrow[\|.\|]{} x$. Ahora bien, 
...
\BeginKnitrBlock{corollary}<div class="corollary"><span class="corollary" id="cor:unnamed-chunk-265"><strong>(\#cor:unnamed-chunk-265) </strong></span>Todo espacio de Hilbert $n$-dimensional es isomorfo a $\mathbb{R}^{n}$. Todo espacio de Hilbert separable, infinito dimensional es isomorfo a $l^{2}$.
</div>\EndKnitrBlock{corollary}

Demos una mirada a los funcionales lineales en los espacios de Hilbert.

\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-266"><strong>(\#def:unnamed-chunk-266) </strong></span>Sea $X$ un espacio vectorial normado sobre $\mathbb{R}$. Una función $T:X\longrightarrow\mathbb{R}$ es un *funcional lineal* si para todo $x,y\in X$ y para todo $\alpha,\beta\in\mathbb{R}$, $T(\alpha x+\beta y)=\alpha T(x)+\beta T(y)$. Decimos que $T$ *es continua en $x_{0}\in X$* si para todo $\epsilon>0$, existe $\delta>0$ tal que, si $\|x-x_{0}\|<\delta$, entonces $|T(x)-T(x_{0})|<\epsilon$. LLamamos a $T$ un *funcional acotado* si existe una constante $C$ tal que $|T(x)|<C\|x\|$ para todo $x\in X$
</div>\EndKnitrBlock{definition}

\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}Note que si $T$ es un funcional lineal continuo en un punto $x_{0}$, entonces lo es en todo punto del espacio vectorial.
</div>\EndKnitrBlock{remark}

Veamos la relación entre la continuidad y la acotación:

\BeginKnitrBlock{lemma}<div class="lemma"><span class="lemma" id="lem:unnamed-chunk-268"><strong>(\#lem:unnamed-chunk-268) </strong></span>Sea $T$ un funcional lineal en un espacio vectorial normado $X$. $T$ es continuo si y solo si $T$ es acotado.
</div>\EndKnitrBlock{lemma}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Supongamos que $T$ es continua en todo $x\in X$, en particular en $x_{0}=0$. Luego, existe $K>0$ tal que si $\|x\|\leq B$, entonces $|T(x)|\leq 1$. Como, para todo $x\in X$,
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-270"><strong>(\#def:unnamed-chunk-270) </strong></span>Sea $T$ un funcional lineal acotado en un espacio vectorial normado $X$. Llamamos norma del funcional $T$ a la menor cota $K$, y se denota por $\|T\|$. Es claro que:
$$\|T\|=\sup_{\substack{x\neq 0}}\frac{|T(x)|}{\|x\|}=\sup_{\substack{\|x\|=1}}{|T(x)|}.$$
</div>\EndKnitrBlock{definition}
\BeginKnitrBlock{theorem}\iffalse{-91-82-105-101-115-122-93-}\fi{}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-271"><strong>(\#thm:unnamed-chunk-271)  \iffalse (Riesz) \fi{} </strong></span>Sea $H$ un espacio de Hilbert separable y $T$ un funcional lineal acotado en $\mathcal{H}$. Entonces, existe $y\in\mathcal{H}$ tal que para todo $x\in\mathcal{H}$, $T(x)=(x,y)$. Además, se tiene que $\|T\|=\|y\|$.
</div>\EndKnitrBlock{theorem}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Sea $(\phi_{n})_{n}$ un sistema ortonormal completo en $\mathcal{H}$. Construímos la siguiente sucesión
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-273"><strong>(\#def:unnamed-chunk-273) </strong></span>Dada una función $f:(a,b)\longrightarrow\mathbb{R}$ y $x\in(a,b)$, definimos las *derivadas de Dini de $f$ en el punto $x$* como sigue:
...
\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}Las derivadas de Dini siempre existen, aunque pueden valer $\infty$ o $-\infty$.
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-275"><strong>(\#def:unnamed-chunk-275) </strong></span>Dado $E\subseteq\mathbb{R}$ un conjunto de números reales. Decimos que $\mathcal{I}$ una colección de intervalos no degenerados es un *cubrimiento de Vitali* de $E$ si para todo $\epsilon>0$ y para todo $x\in E$, existe un intervalo $I\in\mathcal{I}$ tal que $x\in I$ y $l(I)<\epsilon$.
</div>\EndKnitrBlock{definition}

El siguiente teorema es conocido como el *Lema de Vitali*.

\BeginKnitrBlock{theorem}\iffalse{-91-76-101-109-97-32-100-101-32-86-105-116-97-108-105-93-}\fi{}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-276"><strong>(\#thm:unnamed-chunk-276)  \iffalse (Lema de Vitali) \fi{} </strong></span>Sea $E\subseteq\mathbb{R}$ con $m^{\ast}(E)<\infty$. Si $\mathcal{I}$ es un cubrimiento de Vitali de $E$, entonces existe una familia numerable $(I_{n})_{n\in\mathbb{N}}\subseteq \mathcal{I}$ disjunta dos a dos, tal que $$m^{\ast}\left(E\backslash \bigcup_{n\in\mathbb{N}}I_{n} \right)=0.$$
</div>\EndKnitrBlock{theorem}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Sea $\mathcal{O}$ un conjunto abierto que contiene al conjunto $E$, es decir, $E\subseteq \mathcal{O}$. Podemos suponer, que $\forall I\in \mathcal{I}$ $i\subseteq\mathcal{O}$. En caso contrario, consideraremos la colección $\{I\in \mathcal{I}: I\subseteq\mathcal{O}\}$, que resulta ser también un cubrimiento de Vitali del conjunto $E$. Construíremos una colección numerable de intervalos que cumpla las condiciones deseadas. Supongamos, sin pérdida de generalidad, que los intervalos en $\mathcal{I}$ son cerrados, ya que la medida de los extremos de un intervalo es cero.
...
\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}Si la medida del conjunto es infinita, $m^{\ast}(E)=\infty$, se puede tomar $E=\bigcup_{i\in\mathbb{N}}E_{i}$ tal que cada $E_{i}$ tiene medida finita y $E_{i}\cap E_{j}=\emptyset$ siempre que $i\neq j$. Por lo que el teorema también es cierto si $m^{\ast}(E)=\infty$.
</div>\EndKnitrBlock{remark}

En ocaciones el Lema de Vitali se enuncia como el siguiente resultado, que es un corolario inmediato del teorema anterior.

\BeginKnitrBlock{corollary}<div class="corollary"><span class="corollary" id="cor:unnamed-chunk-279"><strong>(\#cor:unnamed-chunk-279) </strong></span>Sea $E\subseteq\mathbb{R}$ con $m^{\ast}(E)<\infty$. Si $\mathcal{I}$ es un cubrimiento de Vitali de $E$, entonces, para todo $\epsilon>0$, existe una colección finita $I_{1},\cdots, I_{N}$ de intervalos disjuntos de $\mathcal{I}$, tales que $$m^{\ast}\left(E\backslash\bigcup_{i=1}^{N}I_{i} \right) <\epsilon.$$
</div>\EndKnitrBlock{corollary}

\BeginKnitrBlock{theorem}\iffalse{-91-76-101-98-101-115-103-117-101-93-}\fi{}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-280"><strong>(\#thm:unnamed-chunk-280)  \iffalse (Lebesgue) \fi{} </strong></span>Sea $f:(\alpha, \beta)\longrightarrow\mathbb{R}$ una función monótona creciente. Entonces $f$ es derivable en c.t.p de $(\alpha,\beta)$. La derivada de $f$, $f´$ es medible Lebesgue y se cumple que si $[a,b]\subseteq (\alpha,\beta)$, entonces
$$\int_{a}^{b} f´(x)dx\leq f(b)-f(a).$$
</div>\EndKnitrBlock{theorem}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Sea $E_{u,v}=\{x\in(\alpha,\beta): D^{+}f(x)>u>v>D_{-}f(x)\}$ para $u,v\in\mathbb{Q}$. Y consideremos 
...
\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}Recordemos que si $\phi$ es la función de Cantor, se tiene que $\phi(1)-\phi(0)\neq 0$. Pero $\phi´=0$. Esto muestra que, en general, si $f$ es monótona, no puede asegurarse que $\int_{a}^{b}f´(x)dx=f(b)-f(a)$.
</div>\EndKnitrBlock{remark}
...
\BeginKnitrBlock{theorem}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-283"><strong>(\#thm:unnamed-chunk-283) </strong></span>Sea $(f_{n})_{n\in\mathbb{N}}$ una sucesión de funciones monótonas crecientes definidas en $[a,b]$ tal que la serie $\sum_{n\in\mathbb{N}} f_{n}(x)$ converge puntualmente en $[a,b]$. Sea $f(x)=\sum_{n\in\mathbb{N}} f_{n}(x)$. Entonces 
$\sum_{n\in\mathbb{N}} f´_{n}(x)=f´(x)$ en c.t.p. de $[a,b]$.
</div>\EndKnitrBlock{theorem}

## Funciones de variación acotada

\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-284"><strong>(\#def:unnamed-chunk-284) </strong></span>Sea $f:[a,b]\longrightarrow\mathbb{R}$. Decimos que $f$ es una *función de variación acotada* en $[a,b]$ si
...
\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}Se puede demostrar fácilmente que las funciones monótonas son de variación acotada. Si $f$ es creciente y $\rho$ es la partición determinada por los puntos $a=x_{0},\cdots, x_{n}=b$, se tiene que 
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-286"><strong>(\#def:unnamed-chunk-286) </strong></span>Dada $f:\mathbb{R}\longrightarrow\mathbb{R}$, la variación total de $f$ sobre un intervalo finito $I$, está defindo como $$V_{f}(I)=\sup_{\substack{\rho\in Par[I]}}\sum_{x_{i}\in\rho} |f(x_{i})-f(x_{i-1})|.$$
</div>\EndKnitrBlock{definition}

\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}Si $f$ es de variación acotada en $[a,b]$, para todo $c\in(a,b)$, se puede probar que $V_{f}(a,b)=V_{f}(a,c)+V_{f}(c,b)$.
</div>\EndKnitrBlock{remark}
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-288"><strong>(\#prp:unnamed-chunk-288) </strong></span>Sea $f$ de variación acotada en $[a,b]$. Sea $V:[a,b]\longrightarrow\mathbb{R}$ la función
...
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Sean $x,y\in[a,b]$ tales que $x\leq y$. Supongamos que $\rho$ es la partición $\{a=x_{0}<\cdots,x_{n}=x\}$, del intervalo $(a,x)$. Si completamos la partición con el punto $y$, se tiene que una partición del intervalo $(a,y)$ y
...
\BeginKnitrBlock{corollary}<div class="corollary"><span class="corollary" id="cor:unnamed-chunk-290"><strong>(\#cor:unnamed-chunk-290) </strong></span>Sea $f:[a,b]\longrightarrow\mathbb{R}$. Entonces $f$ es de variación acotada en $[a,b]$ si y solo si $f$ se escribe como diferencia de funciones monótonas.
</div>\EndKnitrBlock{corollary}
...
\BeginKnitrBlock{corollary}<div class="corollary"><span class="corollary" id="cor:unnamed-chunk-291"><strong>(\#cor:unnamed-chunk-291) </strong></span>Sea $f:[a,b]\longrightarrow\mathbb{R}$ de variaciÓn acotada en $[a,b]$, entonces $f$ es derivable en c.t.p. de $[a,b]$
</div>\EndKnitrBlock{corollary}
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-292"><strong>(\#prp:unnamed-chunk-292) </strong></span>Sea $f:[a,b]\longrightarrow\mathbb{R}$ integrable Lebesgue. Entonces la función 
$$F(x)=\int_{a}^{x} f(t)dt \mbox{ para todo } x\in[a,b]$$
es uniformemente continua y de variación acotada en $[a,b]$.
</div>\EndKnitrBlock{proposition}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Note que $$F(x)=\int_{a}^{x}f^{+}(t)dt-\int_{a}^{x}f^{-}(t)dt$$
...
\BeginKnitrBlock{lemma}<div class="lemma"><span class="lemma" id="lem:unnamed-chunk-294"><strong>(\#lem:unnamed-chunk-294) </strong></span>Si $f$ es integrable en $[a,b]$ y para todo $x\in[a,b]$ $\int_{a}^{x} f(t)dt=0$. Entonces $f=0$ en c.t.p. de $[a,b]$.
</div>\EndKnitrBlock{lemma}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Consideremos el conjunto $E=\{x: f(x)>0 \}$. Supongamos que $m(E)>0$; entonces existe un conjunto cerrado $F\subseteq \mathbb{R}$ tal que $F\subseteq E$ y $m(F)>0$. Tomemos $O=(a,b)\backslash F$. Entonces 
...
\BeginKnitrBlock{theorem}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-296"><strong>(\#thm:unnamed-chunk-296) </strong></span>Sea $f:[a,b]\longrightarrow\overline{\mathbb{R}}$ integrable Lebesgue. La función 
$$F(x)=c+\int_{a}^{x}f(t)dt, \mbox{ con } c\in\mathbb{R}$$ 
es derivable en casi todo punto de $[a,b]$ y $F´(x)=f(x)$ en c.t.p. de $[a,b]$.
</div>\EndKnitrBlock{theorem}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}$F$ es derivable ya que es de variación acotada. Supongamos que $f$ es acotada en $[a,b]$. Sea $M\in\mathbb{R}$ la cota, es decir $|f(x)|\leq M$ para todo $x\in[a,b]$. Definamos, para cada $n\in \mathbb{N}$ una función 
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-298"><strong>(\#def:unnamed-chunk-298) </strong></span>Dada $F:\mathbb{R}\longrightarrow\mathbb{R}$ una función continua y monótona, tal que $F´=0$ c.s. decimos que $F$ es una *función singular*.
</div>\EndKnitrBlock{definition}
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-299"><strong>(\#def:unnamed-chunk-299) </strong></span>Sea $I\subseteq\mathbb{R}$ un intervalo cualquiera. La función $f:I\longrightarrow\mathbb{R}$ es *absolutamente continua en un intervalo acotado* $[a,b]\subseteq I$ si para todo $\epsilon>0$, existe $\delta>0$ tal que si $(a_{i},b_{i})_{i=1}^{n}$ es una colección finita cualquiera de subintervalos disjuntos de $[a,b]$, tienen la propiedad:
$$\sum_{i=1}^{n} (b_{i}-a_{i})<\delta\Rightarrow \sum_{i=1}^{n}|f(b_{i})-f(a_{i})|<\epsilon.$$
</div>\EndKnitrBlock{definition}

\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}La continuidad absoluta implica la continuidad uniforme.
</div>\EndKnitrBlock{remark}

La continuidad absoluta de la integral de Lebesgue, implica la continuidad absoluta de la integral indefinida, esto es,

\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-301"><strong>(\#prp:unnamed-chunk-301) </strong></span>Se $f$ es integrable Lebesgue en $[a,b]$ y $F(x)=F(a)+\int_{a}^{x} f(t)dt$, entonces $F$ es absolutamente continua.
</div>\EndKnitrBlock{proposition}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Sea $\epsilon>0$. Por la continuidad absoluta de la integral que, existe $\delta>0$ tal que 
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-303"><strong>(\#prp:unnamed-chunk-303) </strong></span>Si $f$ es absolutamente continua en $[a,b]$, entonces es de variación acotada en $[a,b]$.
</div>\EndKnitrBlock{proposition}

\BeginKnitrBlock{lemma}<div class="lemma"><span class="lemma" id="lem:unnamed-chunk-304"><strong>(\#lem:unnamed-chunk-304) </strong></span>Si $f$ es absolutamente continua en $[a,b]$ y $f´(x)=0$ en c.t.p. de $[a,b]$, entonces $f$ es constante.
</div>\EndKnitrBlock{lemma}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Sea $c\in[a,b]$. Sea $E\subseteq(a,c)$ tal que $m(E)=c-a$ y $f´(x)=0$ para todo $x\in E$. Sean $\epsilon$ y $\xi$ números reales positivos cualesquiera. Para cada $x\in E$ existe $h$ tal que $[x,x+h]\subseteq[a,c]$ y $|f(x+h)-f(x)|<\xi h$. Por el lema de Vitali, podemos hallar una colección finita $[x_{1},y_{1}],\cdots[x_{n},y_{n}]$ disjuntos dos a dos, tal que $E\backslash\subseteq\bigcup_{k=1}^{n}[x_{k},y_{k}]$ tiene medida menor que $\delta$ siendo este el que da cuenta de la continuidad absoluta de $f$ cuando consideramos el $\epsilon$ ya fijado. Podemos suponer que $a=y_{0}\leq x_{1}< y_{1}\geq \cdots\geq x_{n}<y_{n}=c=x_{n+1}$ y así $$\sum_{k=0}^{n} |x_{k+1}-y_{k}|<\delta.$$
...
\BeginKnitrBlock{theorem}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-306"><strong>(\#thm:unnamed-chunk-306) </strong></span>Una función $F:I\longrightarrow\mathbb{R}$ es una integral indefinida si y solo si es absolutamente continua.
</div>\EndKnitrBlock{theorem}

\BeginKnitrBlock{corollary}<div class="corollary"><span class="corollary" id="cor:unnamed-chunk-307"><strong>(\#cor:unnamed-chunk-307) </strong></span>Toda función absolutamente continua es la integral indefinida de su derivada.
</div>\EndKnitrBlock{corollary}
...
\BeginKnitrBlock{theorem}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-308"><strong>(\#thm:unnamed-chunk-308) </strong></span>Sea $f:(A,\mathcal{F},\mu)\longrightarrow(Y,\mathcal{G})$ medible respecto de $\mathcal{F}$ y $\mathcal{G}$. Sea $\nu=\mu\circ f^{-1}$. Entonces, si $g:(Y,\mathcal{G})\longrightarrow(\overline{\mathbb{R}},\mathcal{M})$ es una función medible, se tiene que 
	$$\int_{Y} g(y)d\nu(y)=\int_{X} g\circ f(x) d\mu(x).$$
</div>\EndKnitrBlock{theorem}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Comencemos por hacer la demostración para una función indicatriz. Supongamos que $g=\chi_{E}$ para algún conjunto medible $E\in\mathcal{G}$. Entonces
...
\BeginKnitrBlock{theorem}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-310"><strong>(\#thm:unnamed-chunk-310) </strong></span>Sea $F:[a,b]\longrightarrow\mathbb{R}$ medible, continua y creciente. Sea $g:\mathbb{R}\longrightarrow\mathbb{R}$ integrable Lebesgue en $[F(a),F(b)]$. Entonces
...
\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}Si $F$ es tal que $F(b)-F(a)=\int_{a}^{b} F´(t)dt$, entonces el teorema anterior concluye que 
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-312"><strong>(\#def:unnamed-chunk-312) </strong></span>Un *rectángulo* en $\mathbb{R}^{n}$ es un subconjunto $A\subseteq\mathbb{R}^{n}$ que es el producto cartesiano de intervalos de cualquier tipo $I_{1},\cdots, I_{n}$ de $\mathbb{R}$, es decir, $A=\prod_{i=1}^{n} I_{i}$.
</div>\EndKnitrBlock{definition}
...
\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}$\mathcal{F}\times\mathcal{G}$ no es una $\sigma$-álgebra, más si un sistema $\pi$.
</div>\EndKnitrBlock{remark}

\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-314"><strong>(\#def:unnamed-chunk-314) </strong></span>La $\sigma$-álgebra producto, denotada $\mathcal{F}\otimes\mathcal{G}$, es la generada por $\mathcal{F}\times\mathcal{G}$, esto es 
$$\mathcal{F}\otimes\mathcal{G}=\sigma(\mathcal{F}\times\mathcal{G}).$$
</div>\EndKnitrBlock{definition}

\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}$\mathcal{B}(\mathbb{R}^{n})=\mathcal{B}(\mathbb{R}^{p})\otimes\mathcal{B}(\mathbb{R}^{q})$, con $n=p+q$.
</div>\EndKnitrBlock{remark}

\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-316"><strong>(\#def:unnamed-chunk-316) </strong></span>Sea $R\in\mathcal{R}_{a}^{n}$ un rectántugo acotado de $\mathbb{R}^{n}$, tal que $R=\prod_{i=1}^{n} I_{i}$. Definimos el área de $R$ como	$$l_{n}(R)=\prod_{i=1}^{n} l(I_{i})$$ donde $l$ es la longitud en $\mathbb{R}$.
</div>\EndKnitrBlock{definition}

\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}La función área, $l_{n}$, se puede extender al anillo generado por $\mathcal{R}_{a}^{n}$.
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-318"><strong>(\#def:unnamed-chunk-318) </strong></span>Sea $A\subseteq\mathbb{R}^{n}$. Definimos $$\mathfrak{R}_{a}^{n}(A)=\left\lbrace (R_{k})_{k}\subseteq\mathcal{R}_{a}^{n}: A\subseteq\bigcup_{k\in\mathbb{N}} R_{k}\right\rbrace $$
...
\BeginKnitrBlock{remark}<div class="remark">\iffalse{} <span class="remark"><em>Nota. </em></span>  \fi{}De forma análoga a lo hecho en $\mathbb{R}$, se tiene que:
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-321"><strong>(\#prp:unnamed-chunk-321) </strong></span>Si $E\in\mathcal{B}(\mathbb{R}^{n})$, con $n=p+q$. Entonces para todo $x\in\mathbb{R}^{p}$, $E_{x}\in\mathcal{B}(\mathbb{R}^{q})$ y para todo $x\in\mathbb{R}^{q}$, $E_{y}\in\mathcal{B}(\mathbb{R}^{p})$.
</div>\EndKnitrBlock{proposition}
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Sea $H=\{E\in\mathcal{B}(\mathbb{R}):\forall x\in\mathbb{R}^{p}(E_{x}\in \mathcal{B}(\mathbb{R}^{q}))\wedge\forall y\in\mathbb{R}^{q}(E_{y}\in \mathcal{B}(\mathbb{R}^{p}))\}$. Claramente $\mathcal{B}(\mathbb{R}^{p})\times\mathcal{B}(\mathbb{R}^{q})\subseteq H$. Además se puede ver que $H$ es una $\sigma$-álgebra. Por lo tanto $\mathcal{B}(\mathbb{R}^{n})=\sigma(\mathcal{B}(\mathbb{R}^{p})\times\mathcal{B}(\mathbb{R}^{q}))\subseteq H$.
</div>\EndKnitrBlock{proof}

\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-323"><strong>(\#prp:unnamed-chunk-323) </strong></span>Sea $A$ un conjunto Boreliano de $\mathcal{B}(\mathbb{R}^{p})\otimes\mathcal{B}(\mathbb{R}^{q})$. Entonces:
...
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Consideremos dos casos. El primero, cuando $A$ es subconjunto de un conjunto de medida finita, es decir, si $A\subseteq H=F\times G$ y $l_{n}(H)<\infty$. Definimos el conjunto,
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-325"><strong>(\#prp:unnamed-chunk-325) </strong></span>Sea $A\in\mathcal{B}(\mathbb{R}^{n})$. Entonces, $l_{n}(A)=0$ si y solo si $l_{p}(A_{y})=0$ en c.t.p. de $\mathbb{R}^{q}$ si y solo si $l_{q}(A_{x})=0$ en c.t.p. de $\mathbb{R}^{p}$.
</div>\EndKnitrBlock{proposition}

Para los conjuntos medibles Lebesgue se tiene un resultado análogo a los visto hasta ahora para los conjuntos borelianos.

\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-326"><strong>(\#prp:unnamed-chunk-326) </strong></span>Sea $E$ un conjunto medible Lebesgue de $\mathbb{R}^{n}$. Entonces:
...
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Sea $E$ un conjunto medible Lebesgue, entonces existen conjuntos borelianos $B_{1}$ y $B_{2}$, tales que $B_{1}\subseteq E\subseteq B_{2}$ y $l_{n}(B_{2}\backslash B_{1})$. Para todo, $x\in\mathbb{R}^{p}$, $B_{1_{x}}\subseteq E\subseteq B_{2_{x}}$ y $B_{1_{x}}, B_{2_{x}}\in\mathcal{B}(\mathbb{R}^{q})$. Por el corolario anterior, $l_{q}(B_{2_{x}}\backslash B_{1_{x}})=0$ en c.t.p. $x\in\mathbb{R}^{p}$. Por lo que $E_{x}\in\mathcal{M}_{q}$. La parte $ii.$ es análoga. Ahora, como $B_{1_{x}}\subseteq E_{x}\subseteq B_{2_{x}}$ y $l_{n}(B_{2}\backslash B_{1_{x}})=0$, las funciones $x\mapsto l_{q}(E_{x})$ y $x\mapsto l_{q}(B_{2_{x}})$ son iguales c.s. Además, $l_{n}(E)=l_{n}(B_{2})$, por lo tanto
...
\BeginKnitrBlock{proposition}<div class="proposition"><span class="proposition" id="prp:unnamed-chunk-328"><strong>(\#prp:unnamed-chunk-328) </strong></span>Sea $f:\mathbb{R}^{n}\longrightarrow \mathbb{R}$.
...
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Sea $A\in\mathcal{B}(\mathbb{R})$;
...
\BeginKnitrBlock{theorem}\iffalse{-91-70-117-98-105-110-105-93-}\fi{}<div class="theorem"><span class="theorem" id="thm:unnamed-chunk-330"><strong>(\#thm:unnamed-chunk-330)  \iffalse (Fubini) \fi{} </strong></span>Sea $\mathbb{R}^{n}=\mathbb{R}^{p}\times\mathbb{R}^{q}$.
...
\BeginKnitrBlock{proof}<div class="proof">\iffalse{} <span class="proof"><em>Demostración. </em></span>  \fi{}Si $h$ es una función indicatriz, el resultado se obtiene de la proposición anterior. Si $h$ es simple no negativa, la linealidad de la integral y lo anterior permiten concluír el resultado.
