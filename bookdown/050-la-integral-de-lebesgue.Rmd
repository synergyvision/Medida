...
```{theorem, name="Beppo-Levy", label="BeppoLevy"}
...
```{proposition, name="Desigualdad de Chebychov"}
...
```{theorem, name="Convergencia dominada de Lebesgue"}
